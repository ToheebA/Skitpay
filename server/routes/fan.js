...
router.post('/subscriptions', authenticateUser, authenticateRole('fan', 'brand'), activateSubscription);
router.delete('/subscriptions/:id', authenticateUser, authenticateRole('fan', 'brand'), cancelSubscription);
